...
#ifndef THIRD_PARTY_GOOGLESQL_GOOGLESQL_BASE_BITS_H_
#define THIRD_PARTY_GOOGLESQL_GOOGLESQL_BASE_BITS_H_
...
inline uint32_t Bits::ReverseBits32(uint32_t n) {
  ...
  return googlesql_base::gbswap_32(n);
#endif
}
...
inline uint64_t Bits::ReverseBits64(uint64_t n) {
  ...
  return googlesql_base::gbswap_64(n);
#else
...
#endif  // THIRD_PARTY_GOOGLESQL_GOOGLESQL_BASE_BITS_H_
