...
#ifndef THIRD_PARTY_GOOGLESQL_GOOGLESQL_BASE_PATH_H_
#define THIRD_PARTY_GOOGLESQL_GOOGLESQL_BASE_PATH_H_
...
//
// Usage:
// string path = googlesql_base::JoinPath("/cns", dirname, filename);
// string path = googlesql_base::JoinPath(getenv("TEST_SRCDIR"), filename);
//
...
// This is the behavior of the old googlesql_base::JoinPath().
// Arguments must be convertible to absl::string_view.
//
// Usage:
// string path = googlesql_base::JoinPathRespectAbsolute("/f", dirname,
// filename);
template <typename... T>
...
#endif  // THIRD_PARTY_GOOGLESQL_GOOGLESQL_BASE_PATH_H_
