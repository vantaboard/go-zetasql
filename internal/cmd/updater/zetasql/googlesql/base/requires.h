...
#ifndef THIRD_PARTY_GOOGLESQL_GOOGLESQL_BASE_REQUIRES_H_
#define THIRD_PARTY_GOOGLESQL_GOOGLESQL_BASE_REQUIRES_H_
...
//
//  template <typename T,
//            typename = std::enable_if_t<googlesql_base::Requires<T>(
...
#endif  // THIRD_PARTY_GOOGLESQL_GOOGLESQL_BASE_REQUIRES_H_
