...
#ifndef GOOGLESQL_COMPLIANCE_RUNTIME_EXPECTED_ERRORS_H_
#define GOOGLESQL_COMPLIANCE_RUNTIME_EXPECTED_ERRORS_H_
...
#endif  // GOOGLESQL_COMPLIANCE_RUNTIME_EXPECTED_ERRORS_H_
