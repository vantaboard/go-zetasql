...
#ifndef GOOGLESQL_ANALYZER_LAMBDA_UTIL_H_
#define GOOGLESQL_ANALYZER_LAMBDA_UTIL_H_
...
// identifiers.
//
// See lambda_parameter_list rule in googlesql.tm about why we cannot simply
...
#endif  // GOOGLESQL_ANALYZER_LAMBDA_UTIL_H_
