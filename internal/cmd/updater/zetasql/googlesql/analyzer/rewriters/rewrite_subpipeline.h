...
#ifndef GOOGLESQL_ANALYZER_REWRITERS_REWRITE_SUBPIPELINE_H_
#define GOOGLESQL_ANALYZER_REWRITERS_REWRITE_SUBPIPELINE_H_
...
#endif  // GOOGLESQL_ANALYZER_REWRITERS_REWRITE_SUBPIPELINE_H_
