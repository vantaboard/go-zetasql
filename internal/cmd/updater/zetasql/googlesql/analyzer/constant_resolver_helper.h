...
#ifndef GOOGLESQL_ANALYZER_CONSTANT_RESOLVER_HELPER_H_
#define GOOGLESQL_ANALYZER_CONSTANT_RESOLVER_HELPER_H_
...
#endif  // GOOGLESQL_ANALYZER_CONSTANT_RESOLVER_HELPER_H_
