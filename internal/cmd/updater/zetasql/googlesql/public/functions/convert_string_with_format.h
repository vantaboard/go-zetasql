...
#ifndef GOOGLESQL_PUBLIC_FUNCTIONS_CONVERT_STRING_WITH_FORMAT_H_
#define GOOGLESQL_PUBLIC_FUNCTIONS_CONVERT_STRING_WITH_FORMAT_H_
...
struct ParsedFormatElementInfo {
  ...
  // Format string for kDecimal output type.
  std::string decimal_format_string;
};
...
#endif  // GOOGLESQL_PUBLIC_FUNCTIONS_CONVERT_STRING_WITH_FORMAT_H_
