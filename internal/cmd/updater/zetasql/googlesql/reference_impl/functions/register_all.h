...
#ifndef GOOGLESQL_REFERENCE_IMPL_FUNCTIONS_REGISTER_ALL_H_
#define GOOGLESQL_REFERENCE_IMPL_FUNCTIONS_REGISTER_ALL_H_
...
#endif  // GOOGLESQL_REFERENCE_IMPL_FUNCTIONS_REGISTER_ALL_H_
